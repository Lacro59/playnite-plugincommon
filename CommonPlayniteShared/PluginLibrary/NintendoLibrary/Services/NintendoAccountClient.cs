...
using CommonPlayniteShared.PluginLibrary.NintendoLibrary.Models;//using NintendoLibrary.Models;
using System;
...
namespace CommonPlayniteShared.PluginLibrary.NintendoLibrary.Services
{
    ...
    public class NintendoAccountClient
    {
        ...
        public NintendoAccountClient(string nintendoPluginUserDataPath)//public NintendoAccountClient(NintendoLibrary library, IPlayniteAPI api)
        {
            //this.library = library;
            this.api = API.Instance;//this.api = api;
            tokenPath = Path.Combine(nintendoPluginUserDataPath, "token.json");//tokenPath = Path.Combine(library.GetPluginUserDataPath(), "token.json");
        }
